...
echo ""
echo "  API:    https://memory.redleif.dev"
echo "  Web UI: https://app.memory.redleif.dev"
echo "  Health: https://memory.redleif.dev/health"
echo ""
echo "If app.memory.redleif.dev is new: add DNS, Cloudflare Access app, and tunnel route (see DEPLOY.md)."
